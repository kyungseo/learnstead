...
[실습 06 — 백업 복원](../../labs/database-safety/06-restore.md)에서 별도 DB에 복원한 기록과 접근 권한을 직접 비교할 수 있습니다.

## ‘얼마나 잃어도 되는가’를 먼저 정하기

하루 한 번 백업한다면 사고 시 마지막 백업 이후 기록을 잃을 수 있습니다. 허용 가능한 데이터 손실 범위를 시간으로 정한 목표가 RPO입니다. 복구에 허용하는 시간이 RTO입니다. 용어보다 ‘최대 몇 시간의 기록 손실을 감당할 수 있는가’, ‘몇 시간 안에 다시 열어야 하는가’를 정하는 것이 먼저입니다.
