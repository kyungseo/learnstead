...
> **왜 읽나:** 모델은 사용자의 이름을 스스로 기억하지 않습니다. 기억하는 것처럼 보이는 이유는 내 프로그램이 필요한 대화 기록을 매번 다시 보내기 때문이며, 실습에서 토큰 수로 확인합니다.
>
...
- 답에서 정해진 필드를 추출하고 검증하는 기능이 없습니다 — [05 구조화 출력](05-structured-output.md)
- 외부 계산기나 검색 도구를 실행하는 기능이 없습니다 — [06 tool calling](06-tool-calling-workflow-agent.md)
