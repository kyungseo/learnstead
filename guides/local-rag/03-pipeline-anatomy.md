...
RAG의 처리는 **문서를 준비하는 색인과 질문에 답하는 질의, 두 흐름으로** 나눌 수 있습니다. 이 구분을 먼저 잡아야 "어디가 틀렸는가"를
좁힐 수 있습니다.


> **왜 읽나:** RAG가 틀렸을 때 생성 모델을 바꾸기 전에 검색된 근거와 원문을 보면 원인을 좁히기 쉽습니다.
>
...
| LLM(생성 모델) | 재색인 불필요 — 프롬프트·호환성·답 품질 재검증 |
| top-k·프롬프트 템플릿 | 재색인 불필요 — 검색·답 품질 재검증 |
