...
[← 이전: 00 — 코드를 둘러싼 큰 그림](00-big-picture.md) · [목차](README.md) · [다음: 02 — 되돌릴 수 있게 만들어 두기](02-safety-net.md)
<!-- learnstead:nav:end -->

> **왜 읽나:** "일단 만들어 줘"로 시작하면 AI가 결과를 내놓더라도 **그게 내가 원한 것인지 판단할 기준이 없습니다**. 기준이 없으면 무엇을 고쳐야 하는지도 매번 다시 정하게 됩니다.
>
