...
| 상태 | 대응 |
| --- | --- |
| 아직 커밋 안 함 | `.gitignore`에 추가하고 커밋 대상에서 빠졌는지 확인. 이미 스테이징하거나 추적한 파일은 제외 설정만으로 빠지지 않으므로 [Git 가이드 11 S10 ②](../git-for-vibe-coders/11-scenarios-share.md) 참고 |
...
| 원인 | 확인 |
| --- | --- |
| 내 컴퓨터에만 있는 파일을 쓰고 있음 | `/Users/내이름/...`처럼 개인 홈 폴더에 의존하는 절대 경로가 코드에 있나 |
...
| 지정한 협업자만 (Private 저장소) | 제한된 사람과 공유 | 링크 전달과 별도로 해당 계정에 접근 권한을 부여해야 함 |
