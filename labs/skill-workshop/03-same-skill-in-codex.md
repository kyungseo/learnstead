...
준비 스크립트가 설치하는 본문은 v1.1이다. 아래의 과거 5행 결과는 v1.0에서 나왔다. 그 차이를 재현하려면 [04의 v1.0 문장](04-tighten-and-collide.md)을 적용하고, 변경한 버전을 결과에 기록한다.
...
| `codex_models_manager` ERROR 줄이 보임 | 모델 캐시 갱신 경고 | 작성 환경에서는 결과를 얻었음. 출력·종료 코드와 함께 확인 |
